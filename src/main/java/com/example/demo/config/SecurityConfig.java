    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("*.css", "*.js", "*.png", "*.jpg", "*.jpeg", "*.gif", "*.svg").permitAll()
            ...
            public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
                ...
                try {
                    if (exception instanceof org.springframework.security.oauth2.core.OAuth2AuthenticationException ex) {
                        var err = ex.getError();
                        details = "code=" + err.getErrorCode() + ", desc=" + String.valueOf(err.getDescription()) + ", uri=" + String.valueOf(err.getUri());
                    }
